    ...
    <motion.div
      ...
      exit={{opacity: 0}}>
        ...
        <div className={classes.title}>
          <h3>Ни одно видео, связанное с выше перечисленными увлечениями, у меня либо ни нашлось, либо мне не нравится Поэтому я здесь будет видео с нашей поездки с друзьями, где мы зажигаем бенгальские огни в лесу после того, как закончили снимать трейлер для несуществующего фильма.</h3>
        </div>
        <VideoPlayer/>
